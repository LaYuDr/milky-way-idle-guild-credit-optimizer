...
window.MwiGuildCreditVersion = "1.1.59";
...
(function (root, factory) {
  ...
  const PANEL_STYLES = `
        ...
        #mwi-credit-optimizer .mwi-price-limit-control{align-self:end;min-width:0}#mwi-credit-optimizer label.mwi-price-limit{display:flex;align-items:center;height:32px;min-height:32px;max-width:100%;border:1px solid #5b5d7b;border-radius:4px;background:#292a46;color:#d8d8e8;font-size:11px;line-height:1.2;white-space:nowrap;overflow:hidden}#mwi-credit-optimizer .mwi-price-limit>span{padding-inline:7px}#mwi-credit-optimizer .mwi-price-limit>span:last-child{padding-inline-start:5px}#mwi-credit-optimizer .mwi-price-limit input{flex:0 0 68px;width:68px;min-width:68px;height:30px;min-height:30px;margin:0;padding:3px 6px;border-width:0 1px;border-radius:0;font-variant-numeric:tabular-nums}#mwi-credit-optimizer .mwi-price-limit input::placeholder{color:#73758a;opacity:1}#mwi-credit-optimizer .mwi-price-limit:focus-within{outline:2px solid #65e3ca;outline-offset:2px}#mwi-credit-optimizer .mwi-price-limit-error{display:block;width:100%;max-width:260px;margin-top:4px;padding:4px 6px;border:1px solid #8f4f5b;border-radius:4px;background:#3d2730;color:#ffbdc3;font-size:10px;line-height:1.35;white-space:normal}#mwi-credit-optimizer .mwi-price-limit-error[hidden]{display:none!important}
        ...
        @container (max-width:390px){#mwi-credit-optimizer .mwi-credit-section table{font-size:10px}#mwi-credit-optimizer .mwi-credit-section th,#mwi-credit-optimizer .mwi-credit-section td{padding:4px 3px;vertical-align:middle}#mwi-credit-optimizer .mwi-credit-section th{font-size:9px}#mwi-credit-optimizer .mwi-credit-section tbody td{overflow:hidden;text-overflow:clip}#mwi-credit-optimizer .mwi-credit-section tbody td:first-child{white-space:normal}#mwi-credit-optimizer .mwi-credit-section tbody td:not(:first-child){white-space:nowrap}#mwi-credit-optimizer .mwi-credit-section .mwi-item{gap:4px}#mwi-credit-optimizer .mwi-credit-section .mwi-item-name{overflow:visible;text-overflow:clip;white-space:normal;overflow-wrap:anywhere;line-height:1.2}#mwi-credit-optimizer .mwi-credit-section .mwi-item-icon,#mwi-credit-optimizer .mwi-credit-section .mwi-market-item-link{width:20px;min-width:20px;height:20px;min-height:20px!important;flex-basis:20px}}
        @container (max-width:300px){#mwi-credit-optimizer .mwi-credit-section table{font-size:9px}#mwi-credit-optimizer .mwi-credit-section th,#mwi-credit-optimizer .mwi-credit-section td{padding:3px 2px}#mwi-credit-optimizer .mwi-credit-section th{font-size:8px;line-height:1.1;white-space:normal}#mwi-credit-optimizer .mwi-credit-item-column{width:33%}#mwi-credit-optimizer .mwi-credit-exchange-column{width:24%}#mwi-credit-optimizer .mwi-credit-unit-cost-column{width:26%}#mwi-credit-optimizer .mwi-credit-target-cost-column{width:17%}#mwi-credit-optimizer .mwi-credit-section .mwi-item{gap:3px}#mwi-credit-optimizer .mwi-credit-section .mwi-item-icon,#mwi-credit-optimizer .mwi-credit-section .mwi-market-item-link{width:18px;min-width:18px;height:18px;min-height:18px!important;flex-basis:18px}}
