...
test("公会代币兑换价值按每枚代币可替代的金币成本排序", () => {
  ...
  assert.equal(values[0].creditItemHrid, "/items/gold_guild_credit");
  assert.equal(values[0].goldValuePerToken, 15000);
  assert.equal(values[1].goldValuePerToken, 800);
