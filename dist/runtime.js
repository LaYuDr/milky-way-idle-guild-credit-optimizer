...
window.MwiGuildCreditVersion = "1.1.23";
...
(function (root, factory) {
  ...
  const STRINGS = {
    "zh-CN": {
      ...
      setGuildLifeTarget: "按公会等级填充（生活）",
      setGuildCombatTarget: "按公会等级填充（战斗）",
    ...
    en: {
      ...
      setGuildLifeTarget: "Fill Life shrine levels",
      setGuildCombatTarget: "Fill Combat shrine levels",
  ...
  function createPanel() {
    ...
    panel.innerHTML = `
      <style>
        ...
        #mwi-credit-optimizer .mwi-upgrade-plan-columns,#mwi-credit-optimizer .mwi-upgrade-plan{display:grid;grid-template-columns:28px minmax(180px,1.5fr) minmax(92px,.65fr) 18px minmax(92px,.65fr) 32px;gap:6px}
        ...
        #mwi-credit-optimizer .mwi-material-row{display:grid;grid-template-columns:minmax(155px,1.15fr) 66px 70px minmax(340px,1.8fr);align-items:center;gap:6px;padding:6px 7px;box-shadow:none}
        ...
        #mwi-credit-optimizer .mwi-material-plans{grid-column:4;display:grid;grid-template-columns:repeat(auto-fit,minmax(165px,1fr));gap:5px;min-width:0}
