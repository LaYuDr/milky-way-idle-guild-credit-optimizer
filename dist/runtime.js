...
window.MwiGuildCreditVersion = "1.1.58";
...
(function (root, factory) {
  ...
  const PANEL_STYLES = `
        ...
        @container (max-width:390px){#mwi-credit-optimizer .mwi-credit-section table,#mwi-credit-optimizer .mwi-credit-section tbody{display:block;width:100%}#mwi-credit-optimizer .mwi-credit-section thead{position:absolute;width:1px;height:1px;margin:-1px;overflow:hidden;clip-path:inset(50%);white-space:nowrap}#mwi-credit-optimizer .mwi-credit-section tbody tr{display:grid;grid-template-columns:minmax(110px,1.2fr) minmax(72px,.8fr) minmax(64px,.7fr);gap:6px 8px;padding:7px 8px;border-top:1px solid #474969}#mwi-credit-optimizer .mwi-credit-section tbody td{min-width:0;padding:0;border:0;overflow:visible;text-overflow:clip}#mwi-credit-optimizer .mwi-credit-section tbody td:first-child{grid-column:1/-1}#mwi-credit-optimizer .mwi-credit-section tbody td:not(:first-child){display:grid;align-content:start;gap:1px}#mwi-credit-optimizer .mwi-credit-section tbody td:not(:first-child):before{color:#aeb1d3;font-size:9px;font-weight:600;line-height:1.2;content:attr(data-label)}#mwi-credit-optimizer .mwi-credit-section tbody td:nth-child(2){text-align:left;white-space:normal;overflow-wrap:anywhere}#mwi-credit-optimizer .mwi-credit-section tbody td:nth-child(3),#mwi-credit-optimizer .mwi-credit-section tbody td:nth-child(4){white-space:nowrap}#mwi-credit-optimizer .mwi-credit-section .mwi-item{align-items:flex-start}#mwi-credit-optimizer .mwi-credit-section .mwi-item-name{overflow:visible;text-overflow:clip;white-space:normal;overflow-wrap:anywhere}}
        @container (max-width:280px){#mwi-credit-optimizer .mwi-credit-section tbody tr{grid-template-columns:repeat(2,minmax(0,1fr))}#mwi-credit-optimizer .mwi-credit-section tbody td:nth-child(2){grid-column:1/-1}}
